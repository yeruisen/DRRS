...
<%
 ...
 <div id="f2">
		<div id="f3">
			<tr>
	    		<td>
					<table width="100%" cellspacing="1" border="1" bordercolordark="#fdfeff" bordercolorlight="#99ccff" style="width: 522px; ">
	            	<tr bgcolor="#e0f0ff">
		       			<td nowrap style="width: 371px; "><div align="center">歌曲名称</div></td>
		       			<td nowrap><div align="center">播放</div></td>
		    		</tr>
<%
	...
	for (java.util.Map.Entry<List<String>, Float> entry : result.entrySet()) {
	 	...
	 	System.out.println(entry.getKey().get(2));
	 	%>
     				<tr>
					<td nowrap><div align="center">&nbsp;<%=entry.getKey().get(0)%>&nbsp;</div></td>
					<td nowrap><div align="center">
						...
						cab#Version=6,4,0,53" type="application/x-oleobject" width="42" height="30" classid="CLSID:22D6F312-B0F6-11D0-94AB-0080C74C7E95" >
						<PARAM NAME="Filename" VALUE="<%=entry.getKey().get(2)%>">
						<PARAM NAME="ShowControls" VALUE="1"> <!-- 控制栏 -->
						<PARAM NAME="autoStart" VALUE="0">
						</OBJECT>
						<%}else{ %>
						<audio src="<%=entry.getKey().get(2)%>" playcount="-1" controls="controls" width="42" height="30">
						</audio>
						<%} %>
					</div></td>
					</tr>
